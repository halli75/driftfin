...
single eval   scan    batch eval   autosubmit
         ...
         reports/   output/   tracker-additions/   data/credentials.csv
                        ...
                        merge-tracker.mjs   data/apply-log.csv
                              |                 |
                         data/applications.csv  dashboard summary
```
...
4. Each attempt is written to `data/apply-log.csv`.
5. Tracker notes and statuses are updated based on the autosubmit outcome.
