# Driftfin — Deutsche Modi (`modes/de/`)

Dieser Ordner enthält die deutschen Übersetzungen der wichtigsten Driftfin-Modi für Bewerber:innen, die im DACH-Raum (Deutschland, Österreich, Schweiz) suchen oder mit deutschen Stellenanzeigen arbeiten.
...
Wenn die meisten deiner Stellenanzeigen auf Englisch sind, bleib bei den Standard-Modi unter `modes/`. Die englischen Modi funktionieren auch fuer deutsche Anzeigen, kennen die DACH-Marktbesonderheiten aber nicht im selben Detail.

## Wie aktivieren?

Driftfin hat keinen "Sprach-Schalter" als Code-Flag. Stattdessen gibt es zwei Wege:
