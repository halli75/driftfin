...
3. **Generate message** using a 3-sentence framework:
   - **Sentence 1 (Hook)**: Something specific about their company or current AI challenge (NOT generic)
   - **Sentence 2 (Proof)**: Candidate's biggest quantifiable achievement relevant to THAT role (e.g. "I built an AI agent handling 90% of customer service at my company before selling it")
   - **Sentence 3 (Proposal)**: Quick chat, no pressure ("Would love to chat about [specific topic] for 15 min")

4. **Alternate targets** with justification for why they are good second choices
