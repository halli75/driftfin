...
Classify the posting into one of the 6 archetypes (see `_shared.md`). If hybrid, indicate the 2 closest. This determines:
...
Table with data and cited sources. If no data is available, say so instead of fabricating.
...
**ALWAYS** log in `data/applications.csv`:
...
- Status: `evaluated`
- PDF: path or empty
- Report: relative link to the report .md (e.g. `reports/001-company-2026-01-01.md`)
